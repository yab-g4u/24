...
import { ArrowRight, Layers, Feather, ShieldCheck, Sparkles } from 'lucide-react';
...
export const LandingView: React.FC<LandingViewProps> = ({ onStart, onSelectCategoryQuick }) => {
  return (
    <section className="relative w-full overflow-hidden flex flex-col items-center justify-center">
      ...
      {/* Existing hero content remains above the video */}
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-14 flex flex-col items-center text-center">
        {/* Social proof banner */}
        <motion.div
